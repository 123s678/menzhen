...
public class Drug implements java.io.Serializable {
  ...
  private Integer cunrushu;
    ...
    public void setMedicalsciencecode(String medicalsciencecode) {
        this.medicalsciencecode = medicalsciencecode;
    }
    ...
    public String getTypeindatetime() {
        return typeindatetime;
    }

    public void setTypeindatetime(String typeindatetime) {
    ...
    public void setAlterdatetime(String alterdatetime) {
    ...
    public Integer getCunrushu() {
        return cunrushu;
    }

    public void setCunrushu(Integer cunrushu) {
        this.cunrushu = cunrushu;
    }
    @Override
    public String toString() {
        return "Drug{" +
                ...
                ", drugname='" + drugname + '\'' +
                ", drugcode='" + drugcode + '\'' +
                ", medicalsciencecode='" + medicalsciencecode + '\'' +
                ", enname='" + enname + '\'' +
                ...
                ", typeinpersonnelid=" + typeinpersonnelid +
                ", typeindatetime='" + typeindatetime + '\'' +
                ", alterpersonnelid=" + alterpersonnelid +
